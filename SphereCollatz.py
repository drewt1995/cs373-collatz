...
MAXCYCLE = 525
CACHE = {}
MAXINCREMENT = {2:2, 3:8, 6:9, 7:17, 9:20, 18:21, 25:24, 27:112, 54:113, 73:116, 97:119, 129:122, 171:125, 231:128, 313:131, 
327:144, 649:145, 703:171, 871:179, 1161:182, 2223:183, 2463:209, 2919:217, 3711:238, 6171:262, 10971:268, 13255:276, 17647:279, 
23529:282, 26623:308, 34239:311, 35655:324, 52527:340, 77031:351, 106239:354, 142587:375, 156159:383, 216367:386, 230631:443, 410011:449, 
511935:470, 626331:509, 837799:525}
FIXEDINCREMENT = [0,
179,
182,
217,
...
def collatz_eval(i, j):
    ...
    max_value = 0
    for key, value in MAXINCREMENT.items():
        if i < j:
            if i <= key <= j:
                if value > max_value:
                    max_value = value
